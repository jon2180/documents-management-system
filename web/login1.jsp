...
<div class="login">
    ...
    <div id="darkbannerwrap"></div>
        ...
        <input name="userId" placeholder="用户名"  type="text" value="1816270246" id="userId" required >
        <hr class="hr15">
        <input name="password" placeholder="密码"  type="password" value="270246" id="password" required>
        <hr class="hr15">
