...
<div class="layui-fluid">
    <div class="layui-row layui-col-space1">
        ...
        <div class="layui-col-md3">
            <button class="layui-btn layui-btn-normal" function="top" topUrl="views/collegeAdmin/addNotice.jsp" topMode="add" topWidth="800px"
                    topHeight=350px" topTitle="新增新增公告信息">
                <i class="layui-icon">&#xe654;</i>新增
            </button>
            <button class="layui-btn layui-btn-danger" function="submit" url="/deleteNoticeAction" isMutiDml="1" isConfirm="1"
