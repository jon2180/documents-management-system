...
<head>
	...
	<script type="text/javascript" src="../../plugins/frame/js_collegeAdmin/fsDict.js?v=1.7.0"></script>
	<script type="text/javascript" src="../../plugins/frame/js_collegeAdmin/fs.js?v=1.7.0"></script>
	<script type="text/javascript" src="../../plugins/frame/js_collegeAdmin/main.js?v=1.7.0"></script>
	...
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-left fsTopMenu" id="fsTopMenu" lay-filter="fsTopMenu">
			<li class="layui-nav-item" >
				<a href="javascript:;" id="donate" lay-filter="rightMenu"><i class="layui-icon layui-icon-about"></i>捐赠</a>
			</li>
		</ul>
		<ul class="layui-nav layui-layout-right rightMenu" id="rightMenu" lay-filter="rightMenu">
			...
			<li class="layui-nav-item layui-hide-xs" lay-id="14" datapid="1">
				<a href="javascript:;">
				...
				<dl class="layui-nav-child" >
					<dd lay-id="141">
						<a href="javascript:;" dataurl="views/home/user_info.jsp" menuid="141"> <i class="fa fa-info-circle"></i><cite>信息修改</cite></a>
					</dd>
					<dd lay-id="142">
						<a href="javascript:;" dataurl="views/home/user_password.jsp" menuid="142"><i class="fa fa-lock"></i><cite>密码修改</cite></a>
					</dd>
					<dd lay-id="143">
						<a href="/loginOutAction"menuid="143"><i class="fa fa-sign-out"></i><cite>安全退出</cite></a>
					</dd>
				</dl>
			</li>
			<!-- 天气信息 -->
...
<!-- 左边菜单 -->
  ...
  <div class="layui-body layui-form"  style="overflow:hidden">
  	<div class="layui-tab layui-tab-card fsTab" lay-filter="fsTab" lay-allowClose="true">
		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show" lay-id="1">
				<iframe src="views/home/colAdmin_iframe.jsp"></iframe>
			</div>
		</div>
	</div>
  </div>
	...
	<div class="layui-footer">
		<!-- 底部固定区域 -->
		©2019 <a href="javascript:;" target="_black">教师档案管理系统</a>
	</div>
</div>
