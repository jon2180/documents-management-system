...
<div class="layui-fluid">
    <div class="layui-row layui-col-space1">
        <blockquote class="layui-elem-quote">
            <span style="color: #FF5722;">系统管理员您好！</span>此页面可以新增、编辑和删除院系管理员公告信息！
        </blockquote>

        <div class="layui-col-md3">
            <button class="layui-btn layui-btn-normal" function="top" topUrl="/views/admin/addNotice.jsp" topMode="add" topWidth="800px"
                    topHeight=350px" topTitle="新增公告信息">
                <i class="layui-icon">&#xe654;</i>新增
            </button>
            <button class="layui-btn layui-btn-danger" function="submit" url="/deleteNoticeAction?ownUserId" isMutiDml="1" isConfirm="1"
        ...
        <div class="layui-col-md12">
            ...
            <script type="text/html" id="barDemo">
                <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="top" topUrl="views/admin/editNotice.jsp"
                   topMode="readonly" topWidth="800px" topHeight="350px" topTitle="查看公告信息" inputs="id:">查看</a>
                <a class="layui-btn layui-btn-xs" lay-event="top" topUrl="views/admin/editNotice.jsp" topMode="edit"
                   topWidth="800px" topHeight="350px" topTitle="编辑公告信息" inputs="id:,user_id:,">编辑</a>
                <!--
